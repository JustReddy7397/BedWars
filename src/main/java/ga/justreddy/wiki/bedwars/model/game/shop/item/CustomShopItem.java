...
public abstract class CustomShopItem {
    ...
    private final Map<GamePlayer, Integer> currentUpgrade;
     ...
     */
    public ItemStack nextUpgrade(GamePlayer player) {
     ...
     */
    public ItemStack previousUpgrade(GamePlayer player) {
        if (!isUpgradable()) return null;
        int currentLevel = currentUpgrade.getOrDefault(player, 0);
     ...
     */
    public ItemStack getCurrentUpgrade(GamePlayer player) {
     ...
     */
    public abstract void onDeath(GamePlayer player);

    /**
     * Defines the behavior of this item when the player respawns.
     * @param player the player who respawns
     */
    public abstract void onRespawn(GamePlayer player);
     ...
     */
    public abstract void onClick(GamePlayer player, ClickAction action);
